...
<b-container class="new">
  ...
  <div class="s4">
    ...
    <b-row class="mt-4" cols="2">
      ...
      <b-col>
        <img class="img-fluid" src="../assets/image/chicken.png" data-aos="flip-left" data-aos-offset="600">
      </b-col>
      <b-col class="border-left border-danger" data-aos="fade-down" data-aos-offset="450">
        <h5 class="n-text" data-aos="fade-left" data-aos-offset="650">雞肉原產地：台灣</h5>
      </b-col>
  </b-row>
  </div>
</b-container>
